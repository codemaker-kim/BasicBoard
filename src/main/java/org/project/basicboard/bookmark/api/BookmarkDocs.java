...
public interface BookmarkDocs {
    @Operation(summary = "북마크 생성", description = "게시글에 북마크를 추가합니다.",
            responses = {
                    @ApiResponse(responseCode = "204", description = "북마크 생성 성공"),
    ...
    @Operation(summary = "북마크 삭제", description = "게시글에서 북마크를 삭제합니다.",
            responses = {
